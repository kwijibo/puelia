...
<xsl:template match="result" mode="meta">
    <base href="http://education.data.gov.uk"/>
	<link rel="shortcut icon" href="http://education.data.gov.uk/images/datagovuk_favicon.png" type="image/x-icon" /> 
...
<xsl:template match="result" mode="style">
	<link rel="stylesheet" href="http://education.data.gov.uk/css/html5reset-1.6.1.css" type="text/css" />
	<link rel="stylesheet" href="http://education.data.gov.uk/css/jquery-ui.css" type="text/css" />
	<link rel="stylesheet" href="http://education.data.gov.uk/css/smoothness/jquery-ui.css" type="text/css" />
	<link rel="stylesheet" href="http://education.data.gov.uk/css/result.css" type="text/css" />
	<xsl:comment>
