...
class LinkedDataApiGraph extends PueliaGraph {
    ...
    function to_simple_json($pageUri){
        ...
        // $labelLabel = $this->get_short_name_for_uri(API.'label');
        // $labelProperty = $this->get_short_name_for_uri(API.'property');
        // $properties = $this->_usedProperties;
        // if (!isset($container['result']['wasResultOf'])) {
        //   $container['result']['wasResultOf'] = array();
        // }
        // if (!isset($container['result']['wasResultOf']['termBinding'])) {
        //   $container['result']['wasResultOf']['termBinding'] = array();
        // }
        // $termBindings = $container['result']['wasResultOf']['termBinding'];
        // $existingTermBindings = array();
        // foreach ($termBindings as $termBinding) {
        //   $existingTermBindings[] = $termBinding[$labelLabel];
        // }
        // foreach ($properties as $label=>$property) {
        //   if (!in_array($label, $existingTermBindings)) {
        //     $termBindings[] = array(
        //         $labelLabel => $label,
        //         $labelProperty => $this->_resource_to_simple_json_object($property, $property, false, array())
        //     );
        //   }
        // }
        // $container['result']['wasResultOf']['termBinding'] = $termBindings;
    ...
    function to_simple_xml($pageUri){
        ...
        // $labelProperty = $this->get_short_name_for_uri(API.'property');
        // $properties = $this->_usedProperties;
        // $termBindingEl = $dom->getElementsByTagName('termBinding')->item(0);
        // if (!$termBindingEl) {
        //   $wasResultOfEl = $dom->getElementsByTagName('wasResultOf')->item(0);
        //   if (!$wasResultOfEl) {
        //     $wasResultOfEl = $dom->createElement('wasResultOf');
        //     $resultEl->appendChild($wasResultOfEl);
        //   }
        //   $termBindingEl = $dom->createElement('termBinding');
        //   $wasResultOfEl->appendChild($termBindingEl);
        // }
        // $existingTermBindings = array();
        // $itemEl = $termBindingEl->firstChild;
        // while ($itemEl) {
        //   $labelList = $itemEl->getElementsByTagName($labelLabel);
        //   if ($labelList->length > 0) {
        //     $textList = $labelList->item(0)->childNodes;
        //     if ($textList->length > 0) {
        //       $existingTermBindings[] = $textList->item(0)->nodeValue;
        //     }
        //   }
        //   $itemEl = $itemEl->nextSibling;
        // }
        // foreach ($properties as $label=>$property) {
        //   if (!in_array($label, $existingTermBindings)) {
        //     $itemEl = $dom->createElement('item');
        //     $labelEl = $dom->createElement($labelLabel);
        //     $labelEl->appendChild($dom->createTextNode($label));
        //     $propertyEl = $dom->createElement($labelProperty);
        //     $propertyEl = $this->write_resource_on_xml_element($dom, $property, $propertyEl, array());
        //     $itemEl->appendChild($labelEl);
        //     $itemEl->appendChild($propertyEl);
        //     $termBindingEl->appendChild($itemEl);
        //     $existingTermBindings[] = $label;
        //   }
        // }
